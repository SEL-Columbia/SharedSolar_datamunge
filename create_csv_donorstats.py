...
pd.DataFrame(make_typday(SDgw_wh.ix['2011-9-14 00:00:00':'2012-10-01 00:00:00'])[0]['ug01_6'], columns = ['m']).join(pd.DataFrame(make_typday(SDgw_wh.ix['2011-9-14 00:00:00':'2012-10-01 00:00:00'])[1]['ug01_6'], columns = ['s'])).to_csv('ug01_6typday.csv')

pd.DataFrame(make_typday(SDgw_wh.ix['2011-11-1 00:00:00':'2013-01-31 23:59:00'])[0]['ml01_13'], columns = ['m']).join(pd.DataFrame(make_typday(SDgw_wh.ix['2011-11-1 00:00:00':'2013-01-31 23:59:00'])[1]['ml01_13'], columns = ['s'])).to_csv('ml01_13typday.csv')

pd.DataFrame(make_typday(SDgw_wh.ix['2011-06-01 00:00:00':'2013-01-31 23:59:00'])[0]['ug02_6'], columns = ['m']).join(pd.DataFrame(make_typday(SDgw_wh.ix['2011-06-01 00:00:00':'2013-01-31 23:59:00'])[1]['ug02_6'], columns = ['s'])).to_csv('ug02_6typday.csv')

pd.DataFrame(make_typday(SDgw_wh.ix['2012-03-01 00:00:00':'2012-06-01 00:00:00'])[0]['ml08_16'], columns = ['m']).join(pd.DataFrame(make_typday(SDgw_wh.ix['2012-03-01 00:00:00':'2012-06-01 00:00:00'])[1]['ml08_16'], columns = ['s'])).to_csv('ml08_16typday.csv')

pd.DataFrame(make_typday(SDgw_wh.ix['2011-10-01 00:00:00':'2013-01-01 00:00:00'])[0]['ug03_2'], columns = ['m']).join(pd.DataFrame(make_typday(SDgw_wh.ix['2011-10-01 00:00:00':'2013-01-01 00:00:00'])[1]['ug03_2'], columns = ['s'])).to_csv('ug03_2typday.csv')
...
SDgw_wh['2011-11-01 00:00:00':'2013-02-01 00:00:00'].resample('M', how = 'max')['ml01_13'].dropna().to_csv('ml01_13_day_peakpow.csv')

SDgw_wh['2011-01-01 00:00:00':'2013-02-01 00:00:00'].resample('M', how = 'max')['ug02_6'].dropna().to_csv('ug02_6_day_peakpow.csv')
...
purch_rec['2011-11-01 00:00:00':'2013-02-01 00:00:00'].resample('M', how = 'sum')['ml01_13'].dropna().to_csv('ml01_13_day_purchrec.csv')

purch_rec['2011-01-01 00:00:00':'2013-02-01 00:00:00'].resample('M', how = 'sum')['ug02_6'].dropna().to_csv('ug02_6_day_purchrec.csv')
